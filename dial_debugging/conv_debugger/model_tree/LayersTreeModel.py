...
class LayersTreeModel(QtCore.QAbstractItemModel):#https://doc.qt.io/qt-5/qtwidgets-itemviews-simpletreemodel-example.html
    ...
    def setupOutputData(self,outputData,parent):
        ...
        for i in range(outputData.shape[3]):
            ...
            parent.appendChild(child)
        return
    def setupBiasData(self,biasData,parent):
    ...
    def setupKernelData(self,kernelData,parent):
    ...
    def setupKernelChannels(self,kernelData,outputIndex,parent):
    ...
    def canFetchMore(self, parent : QtCore.QModelIndex) -> bool:
        """
            Cada ves que se abre una lista, es llamado este metodo para preguntar si el elemento padre
