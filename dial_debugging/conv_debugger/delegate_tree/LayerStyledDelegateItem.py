...
class LayerStyledDelegateItem(PySide2.QtWidgets.QStyledItemDelegate):
    ...
    def paint(self,painter : 'QPainter', option : 'QStyleOptionViewItem', index : 'QModelIndex'):
        ...
        if type(data) is list:
            ...
            super().paint(painter,option,index) #Comportamiento por defecto
        return
    ...
    def setModelData(self,editor : PySide2.QtWidgets.QWidget , model : ' QAbstractItemModel', index : PySide2.QtCore.QModelIndex):
        item = index.internalPointer()
        data = item.data(index.column())
